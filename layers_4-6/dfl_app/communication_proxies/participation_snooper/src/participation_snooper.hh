...
public:
    ParticipationSnooper(
        ...
        std::unordered_map<std::string, ParticipantProxies> &remote_participants,
        ...
        for (auto const &sample : entering_instance_samples) {
            ...
            if (it == m_remote_participants.end())
                m_remote_participants.insert({participant_server_id, {
                    ...
                    .snooper_count = participant_role == "snooper"
                }});
...
private:
    ...
    std::unordered_map<std::string, ParticipantProxies> &m_remote_participants;
